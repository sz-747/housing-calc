...
class ComparisonResult:
    ...
    def __init__(self, data):
        ...
        # year the lines cross on the extended chart, may be beyond the horizon
        self.chart_breakeven_year = data.get("chart_breakeven_year", data["breakeven_year"])
    ...
    def to_dict(self):
        ...
        "chart_breakeven_year": self.chart_breakeven_year,
